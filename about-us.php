...
<body>
    ...
    <div class="container comprehensive-content">
        <div class="row">
            ...
            <div class="comprehensive-text col-sm-12 col-md-6 col-lg-6">
                ...
                <p class="mt-4">Nerdy provides personalized learning in over 3,000 subjects across multiple learning
    ...
    <div class="container talented_teachers">
        ...
        <p>Vnaya.com is owned by E Online Tutors Inc, a company incorporated in the state of Georgia, USA.This company
            was created with one critical aim to add value to the existing education system & become world’s most
            trusted online education brand. Vnaya consolidates to the point that, ” We will do all we can to ensure you
            and your child get the education that leads to success in school and in life!”.<br><br>

            Porter Diagnostic Learning Assessment Process (Porter Process TM) is our unique specialty through which we
            recognize the natural learning style of the students or the children. This approach enables us to recognize
            the unique learning style of the student as well as skill sets ( Cognitive, Physical & Emotional ) or lack
            of them which are needed by the child to learn anything. Based upon this information our tutors modulate
            lesson plans & teaching techniques to empower the child to learn faster & quicker. All of our tutors &
            mentors are trained & certified in the porter process having the acume to teach a student as per his/her
            natural learning style.</p>
    </div>
    ...
    <div class="edge">
        <div class="edge-wrapper">
            <h1 class="edge-title text-center">The Princeton <br class="visible-xs"> Review Edge</h1>
